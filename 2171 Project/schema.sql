...
INSERT INTO student (id,name, email, department) 
VALUES
(620146316, 'John Doe', 'john@example.com', 'Computer Science'),
(620158232,'Jane Smith', 'jane@example.com', 'Electrical Engineering'),
(620146618,'Alice Johnson', 'alice@example.com', 'Mechanical Engineering');