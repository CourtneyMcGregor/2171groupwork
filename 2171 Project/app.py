...
def submit_student():
    ...
    if membership_controller.create_member(club, id_number,name):

          return 'Student Added Successfully'
    
    else:  
        return 'Failed to add student, please check name and ID number and ensure you are not already a member.'
